package com.luopc.platform.web.job.scheduler.config;

import com.luopc.platform.web.job.mapper.*;
import com.luopc.platform.web.job.scheduler.thread.*;
import com.luopc.platform.web.job.scheduler.alarm.JobAlarmer;
import com.luopc.platform.web.job.scheduler.complete.JobCompleter;
import com.luopc.platform.web.job.scheduler.trigger.JobTrigger;
...
public class XxlJobAdminBootstrap implements InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // start
        logger.info(">>>>>>>>>>> xxl-job admin starting: {}",this.shouldInitialize);
    ...
    @Value("${xxl.job.shouldInitialize:true}")
